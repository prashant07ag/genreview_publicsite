...
const ReadyToStandOutSection = () => {
  return (
    <div className="py-8 bg-gradient-to-br from-orange-50 via-orange-50 to-pink-50 relative overflow-hidden">
      {/* Decorative elements */}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="md:w-7/12 space-y-6">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                Ready to <span className="text-[#FF7E67]">stand out</span> from your competition?
              </h2>
              
              <p className="text-gray-700 text-lg max-w-lg">
                Join hundreds of businesses that have transformed their online presence and increased customer engagement with our platform.
              </p>
